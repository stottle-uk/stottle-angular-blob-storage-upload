...
export class AppComponent {
  ...
  onFileChange(event: any): void {
    const accessToken: IBlobAccessToken = {
      ...
      sas: '?st=2018-02-27T14%3A14%3A00Z&se=2018-03-28T13%3A14%3A00Z&sp=rwdl&sv=2017-04-17&sr=c&sig=1Dn3dIoDlGYsXiruSRoIJspzVb8GmuGk6LsBCHudhns%3D',
      storageAccount: 'http://localhost:10000/devstoreaccount1',
      containerName: 'mycontainer'
    };

    this.uploadProgress = this.blob
      .uploadToBlobStorage(accessToken, event.target.files);
  }
}
